...
about = wrap_in_section(
    [
        ddsih.DangerouslySetInnerHTML(
            ...
            <p class="content is-size-4">Explore visualizations of historical wind data recorded at Alaska airports.  Start by choosing an airport to update all graphics below by clicking the map or from a list of airports.</p>
...
<p>Use this chart to explore how the allowable crosswind component exceedance changes with runway direction. The exceedance is the frequency with which hourly winds exceeded the allowable crosswind component threshold displayed.  The three thresholds represent different classes of aircraft. Existing runways are superimposed, hover over corners for info.</p>
  """
    ),
