...
about = wrap_in_section(
    [
        ddsih.DangerouslySetInnerHTML(
            ...
            <p class="content is-size-4">Explore visualizations of historical wind data recorded at Alaska airports.  Start by choosing a location by clicking the map or from a list of airports.</p>
